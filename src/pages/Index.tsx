      ...
      <div className="relative z-10">
        ...
        <main className="container mx-auto px-4 py-12 space-y-12">
          ...
          <div className="text-center space-y-3 max-w-2xl mx-auto animate-fade-up">
            ...
            <p className="text-white/90">{renderSafeContent("Unlike cloud storage services, your files are transferred directly between devices. No servers, no storage, no tracking - just secure, private sharing.")}</p>
            <p className="text-sm text-white/90">{renderSafeContent("Works across all platforms and browsers, bringing AirDrop-like functionality to everyone.")}</p>
          </div>
        </main>
